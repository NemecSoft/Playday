...
export const en = {
  ...
  sidebar_handle_hint: "Click here to search games by tag",
  sidebar_title: "Search games by tag",
  sidebar_close: "Close sidebar",
  sidebar_tagSearch: "Filter tags...",
  sidebar_selected: "{count} tags selected",
  sidebar_clear: "Clear",
  sidebar_noTags: "No tags",
  sidebar_resize: "Drag to resize",
  ...
  // Card text style settings: font-size slider + bold toggle + text preset
  settings_cardFontSize: "Card font size",
  settings_cardFontSizeHint: "Adjust font size of card titles and aliases",
  settings_cardFontBold: "Bold card text",
  settings_cardTextPreset: "Text preset",
  settings_cardTextPresetHint: "Click a preset button to apply; the editor below can still fine-tune.",
  settings_presetSample: "Style",
  settings_preset_normal: "Normal",
  settings_preset_stroke: "Stroke",
  settings_preset_glow: "Glow",
  settings_preset_semi: "Semi",
  settings_preset_shadow: "Shadow",
  settings_preset_sticky: "Sticky",
  settings_cardTextEditor: "Card text style",
  settings_cardTextEditorHint: "Customize: color / stroke / glow / shadow / background",
  settings_cardTextReset: "Reset",
  settings_cardTextPreview: "Preview",
  settings_cardText_color: "Text color",
  settings_cardText_stroke: "Stroke",
  settings_cardText_glow: "Glow",
  settings_cardText_shadow: "Shadow",
  settings_cardText_bg: "Background fill",
  settings_cardTextPreset: "Text preset",
  settings_presetSample: "Style",
  settings_preset_epic: "Epic",
  settings_preset_legendary: "Legendary",
  settings_preset_rare: "Rare",
  settings_preset_classic: "Classic",
